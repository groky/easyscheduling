<?php
require_once("./classes/nb/notice_board.php");
include_once("./classes/nb/functions.php");
...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <link href="css/nb/dp.css" rel="stylesheet" />    
    <link href="css/nb/dropdown.css" rel="stylesheet" />    
    <link href="css/nb/colorselect.css" rel="stylesheet" />   
    ...
    <script src="js/nb/src/Plugins/jquery.form.js" type="text/javascript"></script>     
    <script src="js/nb/src/Plugins/jquery.validate.js" type="text/javascript"></script>     
    ...
    <script src="js/nb/src/Plugins/jquery.dropdown.js" type="text/javascript"></script>     
    <script src="js/nb/src/Plugins/jquery.colorselect.js" type="text/javascript"></script>    
